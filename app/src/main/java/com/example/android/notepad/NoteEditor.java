...
public class NoteEditor extends Activity {
    ...
    private EditText mTitleText;  // 添加标题输入框
    private String mOriginalContent;
    private String mCurrentCategory = "未分类";  // 当前分类
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 设置通知 URI，便于数据变化时自动更新
        if (mCursor != null) {
            mCursor.setNotificationUri(getContentResolver(), mUri);
        }
        ...
        mTitleText = (EditText) findViewById(R.id.note_title);  // 获取标题输入框
    ...
    /**
     * This method is called when the Activity loses focus during its normal operation, and is then
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, Menu.FIRST + 11, 0, "设置分类");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id== R.id.menu_save) {
            ...
            String[] names = {"白色", "绿色", "橙色", "青色", "粉色", "黄色", "紫色"};
            new android.app.AlertDialog.Builder(this)
                    .setTitle("选择笔记颜色")
                    .setItems(names, (d, i) -> {
                        ContentValues v = new ContentValues();
                        v.put(NotePad.Notes.COLUMN_NAME_COLOR, colors[i]);
...
//END_INCLUDE(paste)
    ...
    /**
     * 只更新笔记内容，不更新标题（用于编辑现有笔记时）
     */
    private final void updateNoteContentOnly(String text) {
        if (mUri == null) {
            return;
        }
        ...
        new android.app.AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", (dialog, which) -> {
                    ...
                    if (!categoryName.isEmpty()) {
                        ...
                        updateNoteCategory(categoryName);
                        android.widget.Toast.makeText(this, 
                                "已设置为: " + categoryName, 
                                android.widget.Toast.LENGTH_SHORT).show();
                    }
